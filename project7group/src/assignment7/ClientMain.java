...
public class ClientMain extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		Pane pane = new Pane(); 
		pane.setStyle("-fx-background-color: darkblue, -fx-background;" 
...
//		pane.setPadding(new Insets(20, 20, 20, 20)); 
		...
		userText.setLayoutX(486);
		userText.setLayoutY(10);
		...
		IP.setLayoutX(550);
		IP.setLayoutY(37);
		IPText.setLayoutX(483);
		IPText.setLayoutY(40);
...
//		IP.setPromptText("Enter an IP address...");
		...
		emojiButton.setLayoutX(120);
		emojiButton.setLayoutY(530);
				...
				while ((message = reader.readLine()) != null) {
					if (message.contains("new")) {
						...
						for (int client = 0; client < online.length; client += 1) {
							if (!online[client].equals(this.name) && !clients.contains(online[client])) {
